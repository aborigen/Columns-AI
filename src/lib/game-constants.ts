...
export const FRUIT_TIERS: FruitDefinition[] = [
  ...
  { type: 'lemon', tier: 4, radius: 42, color: '#FFFF4D', score: 15, label: '🍋' },
  { type: 'pear', tier: 5, radius: 50, color: '#B2CF4B', score: 22, label: '🍐' },
  { type: 'peach', tier: 6, radius: 60, color: '#FF9B9B', score: 30, label: '🍑' },
  { type: 'apple', tier: 7, radius: 72, color: '#FF2D2D', score: 45, label: '🍎' },
  { type: 'pineapple', tier: 8, radius: 85, color: '#FFDB58', score: 65, label: '🍍' },
